...
// V4 Configuration testing start
router.get('/configuration', function (req, res) {
  res.render(viewsFolder + 'configuration')
})
...
router.post('/check-your-answers', function (req, res) {
  res.redirect('do-you-want-to-add-another-permit')
})
...
router.get('/search-for-your-address', function (req, res) {
  res.render(viewsFolder + 'search-for-your-address')
})

router.post('/search-for-your-address', function (req, res) {
  res.redirect('select-your-address')
})
...
// End of owner is the appplicant

// Inperuptioon responsibilities
router.get('/interruption-responsibilities', function (req, res) {
  res.render(viewsFolder + 'interruption-responsibilities')
})

router.post('/interruption-responsibilities', function (req, res) {
...
// Enter the owners contact details
...
// Is the specimen alive - Description routing logic
...
// Is the specimen alive alt flow
router.get('/is-the-specimen-alive-alt-flow', function (req, res) {
  res.render(viewsFolder + 'is-the-specimen-alive-alt-flow')
})

router.post('/is-the-specimen-alive-alt-flow', function (req, res) {
  let isAlive = req.session.data['isAlive']

  if (isAlive === 'yes') {
    res.redirect('describe-the-specimen')
  } else {
    res.redirect('describe-the-specimen')
  }
})
...
// Describe the specimen plastron
...
// What is the total weight of your specimen
router.get('/what-is-the-total-weight-of-your-specimen', function (req, res) {
  res.render(viewsFolder + 'what-is-the-total-weight-of-your-specimen')
})

router.post('/what-is-the-total-weight-of-your-specimen', function (req, res) {
  res.redirect('where-are-you-importing-the-specimen-from')
})
...
// Where are you importing your specimen from
...
router.post('/where-did-you-source-your-specimen-from', function (req, res) {
  ...
  if (permitType === 're-export') {
    ...
    res.redirect('do-you-want-to-add-another-specimen')
  }

})

// Do you want to add another specimen
router.get('/do-you-want-to-add-another-specimen', function (req, res) {
  res.render(viewsFolder + 'do-you-want-to-add-another-specimen')
})

router.post('/do-you-want-to-add-another-specimen', function (req, res) {
let addAnotherSpecimen = req.session.data['addAnotherSpecimen']

if (addAnotherSpecimen === 'yes') {
  res.redirect('what-is-the-name-of-your-specimen')
} else {
...
// Do you want to add another permit
router.get('/do-you-want-to-add-another-permit', function (req, res) {
  res.render(viewsFolder + 'do-you-want-to-add-another-permit')
})

router.post('/do-you-want-to-add-another-permit', function (req, res) {
let addAnotherPermit = req.session.data['addAnotherPermit']

if (addAnotherPermit === 'yes') {
  res.redirect('what-type-of-permit-or-certificate-are-you-applying-for')
} else {
...
// Where is the specimen origionally from
...
router.post('/tell-us-about-the-specimens-country-of-origin-export-permit', function (req, res) {
  ...
  router.post('/has-the-specimen-ever-moved-from-its-country-of-origin', function (req, res) {
    ...
    // Is this the only time the specimen has moved from it's country of origin
